...
除了过滤器大小F之外，卷积层还有额外的超参数。**步幅S**控制过滤器移动步长的大小。**填充P**通过向输入的边界添加零（或其他值）来控制输出的大小。

可以使用以下公式计算输出体积的空间维度。以下公式计算输出体积的宽度，用相同的公式计算高度。

$$ W_o = \frac{W - F + 2}{S} + 1 $$

过滤器充当卷积层中的特征检测器，层越深，过滤器越能检测细微的特征。例如，在训练狗猫图像分类的算法时，深层过滤器可能是左耳检测器。
...
![img](https://qqsj789.github.io/img//0-538121-698201.png)
...
![Fig. A1. The standard VGG-16 network architecture](https://qqsj789.github.io/img//Fig-A1-The-standard-VGG-16-network-architecture-as-proposed-in-32-Note-that-only-16346309821105.png)
...
![ResNet: Residual CNNs for Image Classification Tasks](https://qqsj789.github.io/img//resnet-e1548261477164-16346317083449.png)
...
![GoogLeNet](https://qqsj789.github.io/img//166hY3zZTf0Lw2ItybiRxyg-163463207876111.png)
...
![示范网络](https://qqsj789.github.io/img//02-guide-how-transfer-learning-v3-02-163463303424815.png)
